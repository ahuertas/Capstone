...
{
    partial class PDFController : UserControl
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PDFController));
        ...
        {
            InitializeComponent();
            if(axAcroPDF.LoadFile(filename))
            {
                this.axAcroPDF.src = filename;
